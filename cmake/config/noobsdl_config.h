...
#ifndef _NBDL_CONFIGURATION_HEADER_GUARD_H_
#define _NBDL_CONFIGURATION_HEADER_GUARD_H_

#define NBDL_VERSION @VERSION@

// data float precision
#cmakedefine NBDL_TYPE_FP64
#cmakedefine NBDL_TYPE_FP32
#cmakedefine NBDL_TYPE_FP16
#cmakedefine NBDL_TYPE_INT8
