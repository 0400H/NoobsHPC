...
#ifndef NBDNN_ICESWORD_OPERATOR_X86_SOFTMAX_H
#define NBDNN_ICESWORD_OPERATOR_X86_SOFTMAX_H
...
class Operator<X86, SOFTMAX, EType, DType>
    : public OperatorBase<X86, ImplParam<X86, SOFTMAX>> {
public:
    ...
    Status execute(const std::vector<Tensor<X86> *>& inputs,
                    std::vector<Tensor<X86> *>& outputs,
                    ImplParam<X86, SOFTMAX>& param) override;
private:
    size_t thread_num;
    size_t block_size;
};
...
#endif // NBDNN_ICESWORD_OPERATOR_X86_SOFTMAX_H