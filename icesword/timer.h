...
#ifndef NBDNN_ICESWORD_TIMER_H
#define NBDNN_ICESWORD_TIMER_H
...
#include "icesword/tensor/common.h"
#include "icesword/tensor/context.h"
...
public:
    ...
    void start(Context<TType>& ctx) {
        tstart = std::chrono::system_clock::now();
    }

    void end(Context<TType>& ctx) {
