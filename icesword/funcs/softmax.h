...
#ifndef NBDNN_ICESWORD_FUNCS_SOFTMAX_H
#define NBDNN_ICESWORD_FUNCS_SOFTMAX_H

#include "icesword/funcs/base.h"
#include "icesword/funcs/impl/impl_base.h"
#ifdef NVIDIA_GPU
#include "icesword/funcs/impl/cuda/softmax.h"
#include "icesword/funcs/impl/cuda/vender_softmax.h"
#endif

#ifdef USE_X86_PLACE
#include "icesword/funcs/impl/x86/softmax.h"
#endif
#ifdef USE_ARM_PLACE
#include "icesword/funcs/impl/arm/icesword_softmax.h"
#endif
namespace noobsdnn{
...
private:
	...
	//! icesword softmax is better when axis is in outer dims
...
#endif //NBDNN_ICESWORD_FUNCS_SOFTMAX_H
