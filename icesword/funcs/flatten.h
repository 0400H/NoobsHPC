...
#ifndef NBDNN_ICESWORD_FUNCS_FLATTEN_H
#define NBDNN_ICESWORD_FUNCS_FLATTEN_H
...
private:
    ...
    virtual void pick_best_static() override {
        //! flatten only has icesword implementation
...
#endif //NBDNN_ICESWORD_FUNCS_FLATTEN_H
