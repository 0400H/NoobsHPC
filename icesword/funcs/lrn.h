...
#ifndef NBDNN_ICESWORD_FUNCS_LRN_H
#define NBDNN_ICESWORD_FUNCS_LRN_H

#include "icesword/funcs/base.h"
#include "icesword/funcs/impl/impl_base.h"
#ifdef NVIDIA_GPU
#include "icesword/funcs/impl/cuda/lrn.h"
#endif

#ifdef USE_X86_PLACE
#include "icesword/funcs/impl/impl_lrn.h"
#endif
#ifdef USE_ARM_PLACE
//todo
#include "icesword/funcs/impl/impl_lrn.h"
...
public:
    ...
    typedef LrnParam<OpTensor> Param_t;
    ...
    virtual SaberStatus init_impl(ImplEnum implenum) override {
        switch (implenum) {
            case VENDER_IMPL:
                this->_impl.push_back(new VenderLrn <TargetType, OpDtype, inDtype, outDtype,
                LayOutType_op, LayOutType_in, LayOutType_out>);
                return SaberSuccess;

            case ICESWORD_IMPL:
                this->_impl.push_back(new SaberLrn <TargetType, OpDtype, inDtype, outDtype,
                LayOutType_op, LayOutType_in, LayOutType_out>);
                return SaberSuccess;
...
#endif //NBDNN_ICESWORD_FUNCS_LRN_H
