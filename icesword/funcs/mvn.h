...
#ifndef NBDNN_ICESWORD_FUNCS_MVN_H
#define NBDNN_ICESWORD_FUNCS_MVN_H

#include "icesword/funcs/base.h"
#include "icesword/funcs/impl/impl_base.h"
#ifdef NVIDIA_GPU
#include "icesword/funcs/impl/cuda/mvn.h"
#endif

#ifdef USE_X86_PLACE
#include "icesword/funcs/impl/impl_mvn.h"
#endif
#ifdef USE_ARM_PLACE
//todo
#include "icesword/funcs/impl/impl_mvn.h"
...
public:
    ...
    typedef MvnParam<OpTensor> Param_t;
    ...
    virtual SaberStatus init_impl(ImplEnum implenum) override {
        switch (implenum) {
            case VENDER_IMPL:
                this->_impl.push_back(new VenderMvn <TargetType, OpDtype, inDtype, outDtype,
                LayOutType_op, LayOutType_in, LayOutType_out>);
                return SaberSuccess;

            case ICESWORD_IMPL:
                this->_impl.push_back(new SaberMvn <TargetType, OpDtype, inDtype, outDtype,
                LayOutType_op, LayOutType_in, LayOutType_out>);
                return SaberSuccess;
...
private:
    ...
    virtual void pick_best_static() override {
        //! Mvn only has icesword implementation
...
#endif // NBDNN_ICESWORD_FUNCS_MVN_H
