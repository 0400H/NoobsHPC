...
*/
#ifndef NBDNN_ICESWORD_FUNCS_CONV_ACT_H
#define NBDNN_ICESWORD_FUNCS_CONV_ACT_H
...
#ifdef USE_X86_PLACE
#include "icesword/funcs/impl/x86/conv_act.h"
#endif

#ifdef USE_ARM_PLACE
#include "icesword/funcs/impl/arm/icesword_conv_act.h"
#endif
...
public:
    ...
    virtual SaberStatus compute_output_shape(const Input_v &input,
        ...
        // CHECK_LT(input[0]->shape().size(), 4) << "using reshape2d to reshape a 1d conv?";
        ...
        output_shape[channel_idx] = param.conv_param.weight()->num(); // K
    ...
    virtual SaberStatus init_impl(ImplEnum implenum) override {
        switch (implenum) {
            case VENDER_IMPL:
                this->_impl.push_back(new VenderConv2DAct <TargetType, OpDtype, inDtype, outDtype,
                LayOutType_op, LayOutType_in, LayOutType_out>);
                return SaberSuccess;

            case ICESWORD_IMPL:
                this->_impl.push_back(new SaberConv2DAct <TargetType,
    ...
    void update_weights(ConvActiveParam<OpTensor> &param) {
        update_conv_weights<OpTensor, ConvActiveParam>(param);
    }
...
#endif // NBDNN_ICESWORD_FUNCS_CONV_ACT_H
