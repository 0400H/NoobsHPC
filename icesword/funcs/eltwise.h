...
#ifndef NBDNN_ICESWORD_FUNCS_ELTWISE_H
#define NBDNN_ICESWORD_FUNCS_ELTWISE_H

#include "icesword/funcs/base.h"
#include "icesword/funcs/impl/impl_base.h"
#ifdef NVIDIA_GPU
#include "icesword/funcs/impl/cuda/eltwise.h"
#endif

#ifdef USE_X86_PLACE
#include "icesword/funcs/impl/x86/eltwise.h"
#endif
#ifdef USE_ARM_PLACE
#include "icesword/funcs/impl/arm/icesword_eltwise.h"
#endif
namespace noobsdnn {
namespace icesword {
...
public:
    ...
    typedef EltwiseParam<OpTensor> Param_t;
    ...
    virtual SaberStatus init_impl(ImplEnum implenum) override {
        switch (implenum) {
            case VENDER_IMPL:
                this->_impl.push_back(new VenderEltwise <TargetType, OpDtype, inDtype, outDtype,
                LayOutType_op, LayOutType_in, LayOutType_out>);
                return SaberSuccess;

            case ICESWORD_IMPL:
                this->_impl.push_back(new SaberEltwise <TargetType, OpDtype, inDtype, outDtype,
                LayOutType_op, LayOutType_in, LayOutType_out>);
                return SaberSuccess;
...
#endif // NBDNN_ICESWORD_FUNCS_ELTWISE_H
