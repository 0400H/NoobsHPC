...
*/
#ifndef NBDNN_ICESWORD_FUNCS_CROP_H
#define NBDNN_ICESWORD_FUNCS_CROP_H

#include "icesword/funcs/base.h"
#include "icesword/funcs/impl/impl_base.h"
#ifdef NVIDIA_GPU
#include "icesword/funcs/impl/cuda/crop.h"
#endif

#ifdef USE_X86_PLACE
#include "icesword/funcs/impl/impl_crop.h"
#endif
...
public:
    ...
    typedef CropParam<OpTensor> Param_t;
    ...
    virtual SaberStatus init_impl(ImplEnum implenum) override {
        switch (implenum) {
            case VENDER_IMPL:
                this->_impl.push_back(new VenderCrop <TargetType,
                        OpDtype, inDtype, outDtype,
                        LayOutType_op, LayOutType_in, LayOutType_out>);
                return SaberSuccess;

            case ICESWORD_IMPL:
                this->_impl.push_back(new SaberCrop <TargetType,
                        OpDtype, inDtype, outDtype,
                        LayOutType_op, LayOutType_in, LayOutType_out>);
                return SaberSuccess;
