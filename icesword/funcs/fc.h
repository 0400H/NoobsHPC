...
#ifndef NBDNN_ICESWORD_FUNCS_FC_H
#define NBDNN_ICESWORD_FUNCS_FC_H

#include "icesword/funcs/base.h"
#include "icesword/funcs/impl/impl_base.h"
#ifdef NVIDIA_GPU
#include "icesword/funcs/impl/cuda/fc.h"
#include "icesword/funcs/impl/cuda/vender_fc.h"
#endif
...
#ifdef USE_ARM_PLACE
#include "icesword/funcs/impl/arm/icesword_fc.h"
#endif
...
#ifdef USE_CUDA
        bool use_icesword_fc = true;
        use_icesword_fc &= this->_last_input_shape[0] > 1;
        use_icesword_fc &= this->_last_input_shape[0] <= 32;
        if (use_icesword_fc) {
...
#endif //NBDNN_ICESWORD_FUNCS_FC_H
