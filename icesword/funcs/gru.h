...
#ifndef NBDNN_ICESWORD_FUNCS_GRU_H
#define NBDNN_ICESWORD_FUNCS_GRU_H

#include "icesword/funcs/base.h"
#include "icesword/funcs/impl/impl_base.h"
#ifdef NVIDIA_GPU
#include "icesword/funcs/impl/cuda/gru.h"
#include "icesword/funcs/impl/cuda/vender_gru.h"
#endif

#ifdef USE_X86_PLACE
#include "icesword/funcs/impl/x86/gru.h"
#endif
#ifdef USE_ARM_PLACE
//todo
#include "icesword/funcs/impl/impl_gru.h"
#endif
namespace noobsdnn {
namespace icesword {
...
//        if (input[0]->get_seq_offset().size()>0) {
            int hiddenSize = param.bias()->valid_size() / (3 * param.num_direction * param.num_layers);
...
#endif //NBDNN_ICESWORD_FUNCS_GRU_H
