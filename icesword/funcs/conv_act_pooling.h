...
*/
#ifndef NBDNN_ICESWORD_FUNCS_CONV_ACT_POOLING_H
#define NBDNN_ICESWORD_FUNCS_CONV_ACT_POOLING_H

#include "icesword/funcs/base.h"
#include "icesword/funcs/impl/impl_base.h"
#include "icesword/funcs/funcs_utils.h"
#ifdef NVIDIA_GPU
#include "icesword/funcs/impl/cuda/conv_act_pooling.h"
#include "icesword/funcs/impl/cuda/vender_conv_act_pooling.h"
#endif

#ifdef USE_X86_PLACE
#include "icesword/funcs/impl/x86/conv_act_pooling.h"
#endif

#ifdef USE_ARM_PLACE
//todo
#include "icesword/funcs/impl/arm/icesword_conv_act_pooling.h"
#endif
...
private:
    ...
    virtual void pick_best_static() override {
        ...
        bool _use_icesword_conv_pooling = true;
        _use_icesword_conv_pooling &= (this->_param).pooling_param.pad_h == 0;
        _use_icesword_conv_pooling &= (this->_param).pooling_param.pad_w == 0;
        _use_icesword_conv_pooling &= (this->_param).pooling_param.stride_h == 2;
        _use_icesword_conv_pooling &= (this->_param).pooling_param.stride_w == 2;
        _use_icesword_conv_pooling &= (this->_param).pooling_param.window_h == 2;
        _use_icesword_conv_pooling &= (this->_param).pooling_param.window_w == 2;
        _use_icesword_conv_pooling &= !(this->_param).pooling_param.global_pooling;
        _use_icesword_conv_pooling &= (this->_param).pooling_param.pooling_type == Pooling_max;

        if (_use_icesword_conv_pooling) {
...
#endif // NBDNN_ICESWORD_FUNCS_CONV_ACT_POOLING_H
