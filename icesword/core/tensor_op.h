...
/**
* \brief fill_tensor_host_rand fill the host tensor buffer with u8 rand value
* \param tensor  input tensor reference
*/
template <class Tensor_t>
void fill_tensor_host_u8_rand(Tensor_t& tensor);

/**
* \brief fill_tensor_host_rand fill the host tensor buffer with s8 rand value
* \param tensor  input tensor reference
*/
template <class Tensor_t>
void fill_tensor_host_s8_rand(Tensor_t& tensor);
