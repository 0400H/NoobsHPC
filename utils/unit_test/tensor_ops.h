...
#ifndef NBDNN2_UTILS_TEST_TENSOR_OPS_H
#define NBDNN2_UTILS_TEST_TENSOR_OPS_H
...
void fill_tensor_const(noobsdnn::icesword::Tensor<Dim, target, dtype, layout>& tensor, \
    dtype value){

    dtype* data = (dtype*) tensor.get_cpu_data_mutable();
    noobsdnn::icesword::Shape<Dim> shape = tensor.get_shape();
    noobsdnn::icesword::Shape<Dim> real_shape = tensor.get_real_shape();
...
#ifdef USE_ARM_PLACE
template<>
void fill_tensor_const(noobsdnn::icesword::Tensor<4, ARM, float, NCHW>& tensor, \
    float value){

    float* data = (float*) tensor.get_cpu_data_mutable();
    noobsdnn::icesword::Shape<4> shape = tensor.get_shape();
    noobsdnn::icesword::Shape<4> real_shape = tensor.get_real_shape();
...
#ifdef USE_CUDA
template<>
void fill_tensor_const(noobsdnn::icesword::Tensor<4, RTCUDA, float, NCHW>& tensor, \
    float value){
 ...
 */
template<int Dim, TargetType target, typename dtype, LayoutType layout>
void fill_tensor_rand(noobsdnn::icesword::Tensor<Dim, target, dtype, layout>& tensor, \
...
#ifdef USE_ARM_PLACE
template<>
void fill_tensor_rand(noobsdnn::icesword::Tensor<4, ARM, float, NCHW>& tensor, \
...
#ifdef USE_CUDA
template<>
void fill_tensor_rand(noobsdnn::icesword::Tensor<4, RTCUDA, float, NCHW>& tensor, \
    float vstart, float vend){
 ...
 */
template<int Dim, TargetType target, typename dtype, LayoutType layout>
void sum_tensor_cpu(noobsdnn::icesword::Tensor<Dim, target, dtype, layout>& tensor, dtype* sum){
...
#ifdef USE_ARM_PLACE
template<>
void sum_tensor_cpu(noobsdnn::icesword::Tensor<4, ARM, float , NCHW>& tensor, float* sum){
...
#ifdef USE_CUDA
template<>
void sum_tensor_cpu(noobsdnn::icesword::Tensor<4, RTCUDA, float , NCHW>& tensor, float* sum){
 ...
 */
template<int Dim, TargetType target, typename dtype, LayoutType layout>
bool tensor_diff_cpu(noobsdnn::icesword::Tensor<Dim, target, dtype, layout>& tensor1, \
    noobsdnn::icesword::Tensor<Dim, target, dtype, layout>& tensor2, dtype* diff){
    ...
    noobsdnn::icesword::Shape<Dim> real_shape = tensor1.get_real_shape();
...
#ifdef USE_ARM_PLACE
template<>
bool tensor_diff_cpu(noobsdnn::icesword::Tensor<4, ARM, float, NCHW>& tensor1, \
    noobsdnn::icesword::Tensor<4, ARM, float, NCHW>& tensor2, float* diff){
    ...
    noobsdnn::icesword::Shape<4> shape = tensor1.get_shape();
    noobsdnn::icesword::Shape<4> real_shape1 = tensor1.get_real_shape();
    noobsdnn::icesword::Shape<4> real_shape2 = tensor2.get_real_shape();
...
#ifdef USE_CUDA
template<>
bool tensor_diff_cpu(noobsdnn::icesword::Tensor<4, RTCUDA, float, NCHW>& tensor1, \
    noobsdnn::icesword::Tensor<4, RTCUDA, float, NCHW>& tensor2, float* diff){
...
bool tensor_diff_inplace(noobsdnn::icesword::Tensor<4, RTCUDA, float, NCHW>& tensor, float* diff){
...
#endif //NBDNN2_UTILS_TEST_TENSOR_OPS_H
