...
#define TEST(test_class, test_function)	\
	...
	::noobsdnn::test::EnginResOp op_test_class##_##test_function = (::noobsdnn::test::EnginResOp(#test_class,#test_function)\
	>>test_class::get_instance<test_class>() & func_##test_class##_##test_function);\
	void test_class##_##test_function::test_function()


#define InitTest()\
	::noobsdnn::test::config::initial()

#define RUN_ALL_TESTS(argv_0) \
	::noobsdnn::test::EngineTest::get_instance().run_all(argv_0)
