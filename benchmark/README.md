...
The following convolutional neural networks are tested with both `NoobsDNN` and `TenorRT3` on GPU.
...
The following convolutional neural networks are tested with `NoobsDNN`, 'Tensorflow' and `Tensorflow`.
